import { getGameIndex, resetPlayerReady } from "./utils.js";
...
export const submitPlayerCards = (roomNumber, games, phraseCards, jobCards) => {
    ...
    console.log(gameToAddCards.jobCards);
}
